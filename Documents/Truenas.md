...
> If you get stuck at a step just search the answer or contact me though (the Issue tab)[https://github.com/air5551/Repair-guide/issues]
...
A NAS or network attached storage is like cloud storage but instead of being in Icloud or Google Drive, its a dedicated device designed to store data and often for very long periods of time. 
...
> Also **ALL** the data on that disk will be wiped make sure that there is **NOTHING** important

### The Operating system used
[TrueNAS](https://www.truenas.com/) is an Operating system designed solely for NAS devices, its free and perfect for this use. The interface can be quite daughting to people but the guide will tell you how these things work



### Networking
By default all devices on your home network can't be accessed by the wider internet which is a good thing
one soluition is to do what is called port fowarding but this gets really complicated and might not be possible.
...
Go to this (link)[https://www.truenas.com/download-truenas-community-edition/]
...
Flash the USB drive using [][https://etcher.balena.io/]
 1. 
...
3. Plug in the USB drive into the Laptop/Desktop
 ...
 1. Poweroff the laptop completely
 2. Power on the device but constantly press the Bootmenu key, if you don't know search in this [list](https://www.disk-image.com/faq-bootmenu.htm)
> [!NOTE]
